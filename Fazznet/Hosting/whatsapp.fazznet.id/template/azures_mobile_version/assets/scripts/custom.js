	...
	function init_template(){
       ...
       $(".text-size-default").click(function() {$(".text-size-changer *").css("font-size", "");});
        ...
        function isOffline(){
            ...
            setTimeout(function(){$('.offline-message').removeClass('offline-message-active');},5000);
        }
        ...
        function isOnline(){
            ...
            setTimeout(function(){$('.online-message').removeClass('online-message-active');},5000);
        }    
        ...
        function sharingLinks(){
            ...
            $('.shareToWhatsApp').prop("href", "whatsapp://send?text=" + share_msg_wa)
