...
$installe = $rid['installed'] = $installed;
$portapp = $rid['port_app'] = $port_app;
$web_setting = $rid['web_setting'] = $rid['sqlConnect']->query("SELECT * FROM web_setting")->fetch_assoc();
$datdefp = $rid['def_p'] = $rid['sqlConnect']->query("SELECT * FROM def_permission")->fetch_assoc();
