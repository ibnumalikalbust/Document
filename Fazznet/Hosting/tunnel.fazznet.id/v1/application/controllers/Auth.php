...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $subject = "Activation Account NZM ".$this->input->post('name', true);
            $message = '
            Terimakasih anda telah mendaftar di NZM,<br>
        ...
        if($this->form_validation->run() === TRUE){
            ...
            if(!empty($check_email->id)){
                ...
                if(!$action){
                    ...
                    $from = $this->config->item('smtp_user');
                    $to = $email;
                    $subject = "Forget Password NZM";
                    $message = '
                    <h2 style="margin-bottom:0px;">NZM.net</h2>,<br>
